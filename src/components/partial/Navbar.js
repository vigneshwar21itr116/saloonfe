			...
			<div class="header-agile">
				<h1>
					<Link to='/' class="navbar-brand logo">
						<span class="fa fa-scissors" aria-hidden="true" ></span> Rolex	<span class="fa fa-user-secret" aria-hidden="true" ></span>
					</Link>
				</h1>
			</div>
			<div class="nav_w3ls">
				<nav>
					...
					<input type="checkbox" id="drop" />
						<ul class="menu">
							...
							<li class="mr-lg-3 mr-2"><Link to='/contactas'>Contact Us</Link></li>
